...
// ANSWER: 
function findFourthBetter(numbers) {
  if (numbers.length >= 4) {
      return numbers[3];
  } else {
      return null; 
...
// ANSWER: since countletters starts with letter defined it doent change in complexity, but count letters round 2 has to create the letters increasing in space when it is run
